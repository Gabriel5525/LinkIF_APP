...
public class Cadastro_Facilidades extends AppCompatActivity {

    private LinearLayout layout_cadastro;
    private CheckBox checkBox;
    private Button btn_Cadastro_fac;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadastro_facilidades);
        layout_cadastro = findViewById(R.id.layout_cadastro_fac);
        btn_Cadastro_fac = findViewById(R.id.btn_Cadastro_fac);
        ...
        btn_Cadastro_fac.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                for(int i=0;i<listCheckBox.size();i++){
                    ...
                    registro.salvarFacilidade();
                }

                Toast.makeText(Cadastro_Facilidades.this, "Cadastro concluído com sucesso", Toast.LENGTH_SHORT).show();
                abrirTelaPrincipal();
            }
        });
    }
    ...
    private void abrirTelaPrincipal() {
        Intent intent = new Intent(Cadastro_Facilidades.this, MainActivity.class);
